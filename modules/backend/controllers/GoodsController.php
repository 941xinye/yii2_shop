...
use app\modules\backend\actions\GoodsCheckAction;
use app\modules\backend\actions\GoodsDeleteAllAction;
use app\modules\backend\models\GoodsSearch;
...
class GoodsController extends BackendController
{
    ...
    public function actions()
    {
        return array_merge(parent::actions(), [
            'check'=>[
                'class'=>GoodsCheckAction::className(),
                'type'=>Goods::$currentType,
                'status'=>Goods::STATUS_ENABLE
            ],
            'un-check'=>[
                'class'=>GoodsCheckAction::className(),
                'type'=>Goods::$currentType,
                'status'=>Goods::STATUS_DISABLE
            ],
            'delete-all'=>[
                'class'=>GoodsDeleteAllAction::className(),
                'type'=>Goods::$currentType,
            ]
        ]);
    }
